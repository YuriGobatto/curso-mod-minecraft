package com.yurigobatto.tutorialmod.worldgen;
...
public class ModConfiguredFeatures {
    ...
    public static void bootstrap(BootstapContext<ConfiguredFeature<?, ?>> context) {
        ...
        register(context, NETHER_RUBY_ORE_KEY, Feature.ORE,
                new OreConfiguration(netherReplaceable, ModBlocks.NETHER_RUBY_ORE.get().defaultBlockState(), 9));
        register(context, END_RUBY_ORE_KEY, Feature.ORE,
                new OreConfiguration(endReplaceable, ModBlocks.END_STONE_RUBY_ORE.get().defaultBlockState(), 9));
    }
