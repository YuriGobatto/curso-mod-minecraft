package com.yurigobatto.tutorialmod.datagen.loot;
...
public class ModBlockLootTables extends BlockLootSubProvider {
    ...
    protected void generate() {
        ...
        this.add(ModBlocks.RUBY_ORE.get(),
                block -> this.createCopperLikeOreDrops(ModBlocks.RUBY_ORE.get(), ModItems.RAW_RUBY.get()));
        this.add(ModBlocks.DEEPSLATE_RUBY_ORE.get(),
                block -> this.createCopperLikeOreDrops(ModBlocks.DEEPSLATE_RUBY_ORE.get(), ModItems.RAW_RUBY.get()));
        this.add(ModBlocks.NETHER_RUBY_ORE.get(),
                block -> this.createCopperLikeOreDrops(ModBlocks.NETHER_RUBY_ORE.get(), ModItems.RAW_RUBY.get()));
        this.add(ModBlocks.END_STONE_RUBY_ORE.get(),
                block -> this.createCopperLikeOreDrops(ModBlocks.END_STONE_RUBY_ORE.get(), ModItems.RAW_RUBY.get()));
        ...
        LootItemCondition.Builder lootitemcondicion$builder = LootItemBlockStatePropertyCondition
                .hasBlockStateProperties(ModBlocks.PINEAPPLE_CROP.get())
                .setProperties(StatePropertiesPredicate.Builder.properties().hasProperty(PineappleCropBlock.AGE, 4));
        this.add(ModBlocks.PINEAPPLE_CROP.get(), createCropDrops(ModBlocks.PINEAPPLE_CROP.get(), ModItems.PINEAPPLE.get(),
                ModItems.PINEAPPLE_SEEDS.get(), lootitemcondicion$builder));
    }
